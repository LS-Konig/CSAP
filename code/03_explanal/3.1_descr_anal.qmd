...
```{mermaid}
flowchart TD
    A("Respondents <br> N = 29,827") 
        -->|36.5%| B("No Party Attachement <br> N = 10,880") 
    A 
        -->|61.5%| C("Party Attachement <br> (explicit) <br> N = 18,357")

    B -->|35.8%| D("No Vote reported <br> (non-partisan) <br> N = 3,900")
    B -->|57.3%| E("Vote reported <br> (implicit) <br> N = 6,234")

    C -->|5.6%| F("No Vote reported <br> N = 1,030")
    C -->|92.2%| G("Vote reported <br> N = 16,917")

    G -->|78.1%| H("Same as <br> Party Attachement <br> N = 13,220")
    G -->|21.9%| I("Diff from <br> Party Attachement <br> N = 3,697")
```
...
#| fig-dpi: 500
#| fig-cap: "Distribution of token allocation by game. Dictator game: $Mean = 3.41$, $median = 4$, $SD = 2.35$. Trust game: $Mean = 3.48$, $median = 4$, $SD = 2.49$"
#| fig-pos: H
