...
rm(bfit_base_d, newdata_base_d, evs_base_d, qois_base_d, plot_base_d)
```
...
rm(bfit_base_t, newdata_base_t, evs_base_t, qois_base_t, plot_base_t)
```
...
evs_cov_d <- estimate_evs(bfit_cov_d, newdata_cov_d)
...
rm(bfit_cov_d, newdata_cov_d, evs_cov_d, qois_cov_d, plot_cov_d)
```
...
evs_cov_t <- estimate_evs(bfit_cov_t, newdata_cov_t)
...
rm(bfit_cov_t, newdata_cov_t, evs_cov_t, qois_cov_t, plot_cov_t)
```
