...
Temporal limitation: - Data stem from a single cross-sectional wave
(2019).\\
...
affect: - the magnitude of AP, - cross-country rankings, - and
substantive inferences about democratic implications.
...
- concept, - measurement, - and behavioral manifestation.
...
Conceptual shift: - From \textbf{attitudinal differentiation toward
parties (vertical)}\\
to\\
...
Here, affective polarization manifests as: - Differential allocation
toward co-partisans vs.~out-partisans.
...
Possible empirical extension: - Estimate correlation between
country-level attitudinal AP and behavioral AP (posterior correlation).
...
Possible extension: - Incorporate prior information about realistic
joint distributions of religion × partisanship to simulate more
externally valid scenarios. - Use the uniform design as a benchmark
(``no-sorting counterfactual'') against which realistic sorting patterns
could be contrasted.
...
Potential extension: - Estimate posterior correlation between
country-level attitudinal AP and behavioral AP.
