...
How does partisan type influence affective polarization?
Despite rapid growth in the study of affective polarization over the past decade, important ambiguity remains in how scholars conceptualize and measure the phenomenon. 
Existing approaches differ markedly in the populations they target: some measure affective polarization only among self-identified partisans, while others attempt to capture partisan affect across the broader electorate.
Yet the goal of these studies is often the same—drawing inferences about the level or trajectory of affective polarization in a given society.
When measures rely on partisan subsamples, however, their generalizability rests on strong and typically untested assumptions about who counts as a partisan and whether that subset is sufficiently large or representative of the population.
In short, inferences about societies often hinge on implicit assumptions about the structure of partisanship.

This study addresses this conceptual and empirical gap by clarifying who is included in the study of affective polarization and why that choice matters.
Building on existing distinctions between partisan identifiers and those who merely express vote preferences—as discussed in prior work on implicit partisanship and partisan closeness—I introduce the concept of partisan type to analytically distinguish between explicit and implicit partisans.
This refinement does not claim to invent a new category; rather, it systematizes and extends existing conceptual debates in a way that is more suitable for multiparty European democracies, where levels of reported partisan identification tend to be lower and more heterogeneous than in the United States.

Empirically, I map the distribution of partisan types across 25 European multiparty systems, documenting substantial cross-national variation in the relative shares of explicit and implicit partisans but a striking consistency in the overall prevalence of partisanship.
I then move beyond descriptive patterns to ask a causal question: How would individuals’ affective polarization shift if, hypothetically, their partisan type changed?
To approximate this hypothetical intervention, I employ hierarchical Bayesian models that leverage a unique conjoint design and the multilevel structure of the data.
This framework allows me to estimate how explicit versus implicit partisan attachment conditions responsiveness to partisan cues, while accounting for confounding individual, party, and country-level factors.

Theoretically, affective polarization centers on subjective group identities and the affective mechanisms through which individuals form in-group attachments and out-group antagonisms.
From a social identity perspective, explicit partisans—those who report subjective attachment—should exhibit stronger affective polarization than implicit partisans, who choose a party but deny feeling close to it.
Explicit identification signals stronger group identity and should therefore amplify both positive affect toward in-groups and negative affect toward out-groups.

Finally, I place these results in comparative perspective, assessing whether the relationship between partisan type and affective polarization varies across national contexts.
