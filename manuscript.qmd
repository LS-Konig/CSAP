...
### Introducting *Partisan Type*_ Explicit vs Implicit Partisanship
...
Building on insights from the U.S. literature on implicit vs explicit identity, I refine this distinction for comparative multiparty settings by distinguishing between:
  ...
  - *implicit partisans*: respondents who express a vote choce but explicitly deny attachement
...
Country EV results -\> Slight shifts in general baseline of tokens, but pattern remains constant
