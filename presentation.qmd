...
::: {.embed-fig}
<!-- embed removed with the notebooks (backup commit 4651e2c): code/03_explanal/3.1_descr_anal.qmd#fig-impl-expl-distribution -->
:::
...
<!-- embed removed with the notebooks (backup commit 4651e2c): code/03_explanal/3.2_ap_measures.qmd#fig-eu25-ap-comparison-thermo -->
:::
:::
...
::: {.embed-fig .embed-pair}
<!-- embed removed with the notebooks (backup commit 4651e2c): code/03_explanal/3.2_ap_measures.qmd#fig-eu25-ap-comparison-cj -->
:::
:::
:::
