...
## Datasets for affective polarization in Europe, by measurement quadrant

### Cross-national survey infrastructures

| Dataset | Quadrants | Link | Notes |
|---|---|---|---|
| CSES (Modules 1–6 + IMD) | VA | https://cses.org/data-download/download-data-documentation/ | 0–10 like–dislike for parties *and* leaders; branching closeness item (close → leaner → strength) + vote recall. IMD: ~395k respondents, 230 elections, 59 polities. |
| CSES Module 6 (2021–2026) | VA | https://cses.org/data-download/cses-module-6-2021-2026/ | Second advance release Dec 2025, 18 studies / 17 countries; full release pending. |
| European Election Study 2024 (Voter Study, ZA8868) | VA | https://search.gesis.org/research_data/ZA8868 | 27 member states, 25,904 respondents; PTVs rather than thermometers; items linkable to CHES. |
| EES series 1989–2019 | VA | https://www.gesis.org/en/services/finding-and-accessing-data/international-survey-programs/european-election-studies | Long over-time series with consistent core items. |
| European Social Survey (R1–R11) | — (partisanship only) | https://www.europeansocialsurvey.org/data-portal | No party thermometers. Use for classifying implicit vs explicit partisans and for trust/participation outcomes. R11 = 31 countries. |

### National panels and election studies

| Dataset | Quadrants | Link | Notes |
|---|---|---|---|
| TRI-POL (ES, PT, IT, AR, CL) | VA, HA, + digital trace | https://osf.io/3t7jz/ · https://www.upf.edu/web/tri-pol | 3 waves, Sept 2021–Apr 2022; embedded experiments on social exposure, framing, social sorting; device-tracked trace data matched to survey. No "don't know" option except knowledge items — useful control for non-response artefacts. |
| TRI-POL data paper | — | https://www.sciencedirect.com/science/article/pii/S2352340923003384 | Variable inventory; read before downloading. |
| POLAT Panel (Spain, 12 waves) | VA, HA | https://doi.org/10.34810/DATA1486 · paper: https://www.nature.com/articles/s41597-025-05684-4 | Built specifically because household panels carry thin political batteries. |
| LISS panel (NL) | VA, HA | https://www.lissdata.nl · https://www.dataarchive.lissdata.nl/study-units/view/22 | Probability panel; carries like–dislike toward party *supporters*, not just parties. Accepts external module proposals — route to adding VB/HB on the same respondents. |
| BES Internet Panel (UK) | VA | https://www.britishelectionstudy.com/data-objects/panel-study-data/ · https://doi.org/10.5255/UKDA-SN-8202-2 | Waves 1–29, ~30k per wave; paradata (response times) for satisficing checks. |
| GLES Panel 2016–2021 (DE) | VA | https://doi.org/10.4232/1.14114 · https://www.gesis.org/en/gles | Scalometers for parties and leaders; PID with strength. |
| AUTNES Online Panel 2017–2024 (AT) | VA | https://doi.org/10.11587/HNUFCC | Long multi-wave voter panel, recently documented. |
| Finnish online panel (Kekkonen & Ylä-Anttila) | VA, HA | https://www.frontiersin.org/journals/political-science/articles/10.3389/fpos.2022.920567/full | Partisan social distance + like–dislike; directly addresses how in/out-groups should be defined under multipartyism. |

### Behavioural / experimental

| Dataset | Quadrants | Link | Notes |
|---|---|---|---|
| Hahm, Hilpert & König, "Divided We Unite" (APSR) | HB, VA | https://www.cambridge.org/core/journals/american-political-science-review/article/divided-we-unite-the-nature-of-partyism-and-the-role-of-coalition-partnership-in-europe/B46AE5A929EA42FE817FE6273B0243E8 | Dictator + trust games, in-party favouritism vs out-party derogation decomposed; 29,827 respondents, 178,936 decisions. |
| Hahm et al., "Divided by Europe" (WEP) | HB, VA | https://www.tandfonline.com/doi/full/10.1080/01402382.2022.2133277 | Dictator games, 25 member states, hypothetical stakes. |
| "(Alleged) consequences of AP", 9 democracies (EJPR) | HA, HB | https://www.cambridge.org/core/journals/european-journal-of-political-research/article/alleged-consequences-of-affective-polarization-a-survey-experiment-in-nine-democracies/22A263E738B4718273BE92A52D2582ED | Manipulates AP directly, measures downstream behavioural/normative outcomes. |
| OECD Trustlab | (HB baseline only) | https://www.oecd.org/en/publications/trust-and-its-determinants_869ef2ec-en.html | Incentivized trust/dictator/public-goods + institutional IAT in FR, DE, IT, SI, LU, UK. Counterparts are anonymous strangers — no partisan cue, so use as a prosociality baseline, not an AP measure. |

### Measurement references (not datasets)
...
| Garzia et al., parties vs leaders (APSR) | https://www.cambridge.org/core/journals/american-political-science-review/article/patterns-of-affective-polarization-toward-parties-and-leaders-across-the-democratic-world/E1C891801A4CB1DEBE2AACE6446F6845 | Splits the vertical dimension into party- and leader-directed. |
| Handbook of Affective Polarization, ch. 2 (open access) | https://www.elgaronline.com/edcollchap-oa/book/9781035310609/chapter2.xml | Conceptual inventory of measures across all four quadrants. |

## Datasets for partisanship over time in Europe

### Long backbone (individual-level attachment)

| Dataset | Coverage | Link | Notes |
|---|---|---|---|
| Mannheim Eurobarometer Trend File | 1970–2002, Western Europe | https://www.gesis.org/en/eurobarometer-data-service/overview/eb-trends-trend-files/mannheim-eb-trend-file · https://search.gesis.org/research_data/ZA3521 (DOI 10.4232/1.10074) | Ed. 2.0.1: 86 waves, 145 variables, >1m cases; free after registration. Carries **both** party attachment and party preference → the implicit/explicit partisan split is constructible back to the early 1970s. Wording variation documented in the codebook; not all trend variables present in all waves — verify item coverage wave by wave. |
| Standard Eurobarometer post-2002 | 2002– | https://www.gesis.org/en/eurobarometer-data-service | Attachment battery largely dropped → discontinuity after the trend file ends. |

### Post-2002 continuation

| Dataset | Coverage | Link | Notes |
|---|---|---|---|
| ESS, rounds 1–11 | 2002–2024, ~30 countries | https://www.europeansocialsurvey.org/data-portal | "Closer to a particular party than all others" + strength + vote recall. Consistent wording, probability samples. R12 (2025/26) goes mixed-mode → expect a break. |
| CSES, modules 1–6 + IMD | 1996–2026, election-based | https://cses.org/data-download/download-data-documentation/ | **Only source with the leaner probe** → the only consistent over-time decomposition of "no attachment" into leaners vs true non-partisans. Best series for the implicit-partisan question specifically. |
| EES, 1989–2024 | Five-yearly, EU-wide | https://www.gesis.org/en/services/finding-and-accessing-data/international-survey-programs/european-election-studies | Closeness + strength + EP and national vote recall. |
| ISSP background variables | 1985– | https://www.gesis.org/en/issp | Party affiliation as a standard background item. |

### National series (longer than any cross-national source)

| Dataset | Coverage | Link | Notes |
|---|---|---|---|
| Politbarometer (DE) | monthly, 1977– | https://www.gesis.org/en/elections-home/politbarometer | Monthly Parteineigung with cumulative file; within-year variation no cross-national source matches. |
...
### Aggregate proxies for the same decline

| Dataset | Coverage | Link | Notes |
|---|---|---|---|
| MAPP party membership dataset | 1945–2014, 31 countries | https://zenodo.org/record/61234 · paper: https://link.springer.com/article/10.1057/s41304-016-0098-z | 6,307 membership observations across 397 parties. Organizational counterpart to declared attachment. |
| Electoral volatility datasets (Emanuele et al.) | national since 1945; EP since 1979 | https://access.gesis.org/sharing/2739/5793 | Behavioural counterpart: volatility as revealed weak attachment. |
| Party Facts | — | https://partyfacts.org | Party ID crosswalk for merging all of the above. |

### Comparability caveats

- **Wording is not equivalent.** Eurobarometer asks about *attachment* with degrees; ESS asks whether you feel closer to one party *than all others* (a relative, lower bar); CSES asks whether you *usually think of yourself* as close, then probes leaners. Non-attachment rates differ systematically as a result — compare slopes within a source, never levels across sources.
- **Mode transitions bite this construct hardest.** The implicit-partisan group is defined by a negative answer on one item and a positive on another, exactly where self-completion vs interviewer effects are strongest. EES moved online, national studies migrated to web panels, ESS R12 is mixed-mode. A jump in implicit partisans around a mode switch is not evidence of dealignment.
- **Practical rule:** treat each source as its own series, never splice, anchor claims to constant-mode/constant-wording stretches. Mannheim trend file and Politbarometer give the longest such stretches.
